...
const API = axios.create({ baseURL: `https://null-youtube.onrender.com/` });
...
export const otp = (number) => API.post("/user/otp", number);
export const numchange = (usernum) => API.post("/user/number", usernum);
